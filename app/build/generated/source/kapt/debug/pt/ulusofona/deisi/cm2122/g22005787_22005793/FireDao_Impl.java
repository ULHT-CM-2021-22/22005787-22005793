...
public final class FireDao_Impl implements FireDao {
  ...
  public Object getAll(final Continuation<? super List<FireRoom>> continuation) {
    final String _sql = "SELECT * FROM fires ORDER BY data DESC";
  ...
  @Override
  public Object getFromRegion(final String distrito,
      final Continuation<? super List<FireRoom>> continuation) {
    final String _sql = "SELECT * FROM fires WHERE distrito = ? ORDER BY data DESC ";
